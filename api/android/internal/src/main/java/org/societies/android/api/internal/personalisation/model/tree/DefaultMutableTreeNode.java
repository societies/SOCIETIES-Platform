...
package org.societies.android.api.internal.personalisation.model.tree;
   // ISSUE: this class depends on nothing in AWT -- move to java.util?

import java.io.*;
import java.util.*;

import org.societies.android.api.internal.personalisation.model.AContextPreferenceCondition;
import org.societies.android.api.internal.personalisation.model.APreference;
import org.societies.android.api.internal.personalisation.model.APreferenceOutcome;
import org.societies.android.api.internal.personalisation.model.APreferenceTreeModel;
       ...
       MutableTreeNode, Parcelable
{
	...
	public void writeToParcel(Parcel out, int flags) {
		...
		out.writeByte((byte) (this.allowsChildren ? 1 : 0));  
	...
	private DefaultMutableTreeNode(Parcel in){
		super();
		this.allowsChildren = in.readByte() == 1;
		this.readChildren(in.readParcelableArray(APreference.class.getClassLoader()));
		this.parent = (DefaultMutableTreeNode) in.readParcelable(DefaultMutableTreeNode.class.getClassLoader());
	...
	public static final Parcelable.Creator<DefaultMutableTreeNode> CREATOR = new Parcelable.Creator<DefaultMutableTreeNode>() {

        public DefaultMutableTreeNode createFromParcel(Parcel in) {
            return new DefaultMutableTreeNode(in);
        }

        public DefaultMutableTreeNode[] newArray(int size) {
            return new DefaultMutableTreeNode[size];
        }
