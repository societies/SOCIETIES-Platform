 ...
 * @author Scott Violet
 */
public class DefaultTreeModel implements Parcelable, TreeModel {
    /** Root of the tree. */
...
/*        // Guaranteed to return a non-null array
	...
	public void writeToParcel(Parcel out, int flags) {
		out.writeByte((byte) (this.asksAllowsChildren ? 1 : 0));   
		
		
	}

	private DefaultTreeModel(Parcel in){
		super();
		this.asksAllowsChildren = in.readByte() == 1;
		
	}
	
	
	public static final Parcelable.Creator<DefaultTreeModel> CREATOR = new Parcelable.Creator<DefaultTreeModel>() {

        public DefaultTreeModel createFromParcel(Parcel in) {
            return new DefaultTreeModel(in);
        }

        public DefaultTreeModel[] newArray(int size) {
            return new DefaultTreeModel[size];
        }
