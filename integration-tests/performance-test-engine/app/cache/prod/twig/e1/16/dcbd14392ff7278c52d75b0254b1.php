...
\t<ul>
  \t\t";
        // line 11
        if (isset($context["performance_tests_list"])) { $_performance_tests_list_ = $context["performance_tests_list"]; } else { $_performance_tests_list_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_performance_tests_list_);
        foreach ($context['_seq'] as $context["_key"] => $context["performance_test"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_get_performance_test_by_id", array("test_id" => $this->getAttribute($_performance_test_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["performance_test"])) { $_performance_test_ = $context["performance_test"]; } else { $_performance_test_ = null; }
