...
class PerformanceTest extends \Societies\TestEngineBundle\Entity\PerformanceTest implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setTestUri($testUri);
    }

    public function getTestUri()
    {
        $this->__load();
        return parent::getTestUri();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'test_name', 'test_description', 'test_developer_name', 'test_uri', 'performanceTestParameters', 'performanceTestResults');
    }
