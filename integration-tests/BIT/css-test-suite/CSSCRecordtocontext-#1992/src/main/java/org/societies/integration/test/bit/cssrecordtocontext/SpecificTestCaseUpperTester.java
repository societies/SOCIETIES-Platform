...
private static Logger LOG = LoggerFactory.getLogger(SpecificTestCaseUpperTester.class);
	...
	public static final String TEST_POSITION = "developer";
	...
	@Before
	public void setUp() {
		LOG.info("[#1992] SpecificTestCaseUpperTester::setUp");

		Future<CssInterfaceResult> interfaceResult = null;
		//CssRecord profile = null;
		
		profile = createCSSRecord();
		LOG.info("[#1992] SpecificTestCaseUpperTester CSS Record: profile:" +profile);

			// -- Create the CSS Record
		
			LOG.info("[#1992] SpecificTestCaseUpperTester Preamble: Create the CSS Record");
	}
	...
	public void tearDown() {
		LOG.info("[#1992] SpecificTestCaseUpperTester tearDown");
	}
	
	
	@Ignore
	public void bodyCreateNodetwice() {
		LOG.info("[#1992] SpecificTestCaseUpperTester create CSS Cloud Node");
		String Name = null;
		Name ="liam";
		String compareName;
		...
		try {
			...
			LOG.info("[#1992] SpecificTestCaseUpperTester CssRegistrationException - Could not get the CSS Record from the CSS Registry");
			e.printStackTrace();
		}
		...
		try {
			...
			LOG.info("[#1992] SpecificTestCaseUpperTester Name of CSS is .................:" +Name);
		} catch (CssRegistrationException e) {
			LOG.info("[#1992] SpecificTestCaseUpperTester CssRegistrationException - Could not get the CSS Record Name from the CSS Registry");
			e.printStackTrace();
		}
		...
		interfaceResult = TestCase1992.cssLocalManager.registerCSSNode(profile);
		LOG.info("[#1992] SpecificTestCaseUpperTester CreateNodetwice END.................");
	}
	...
	public void bodydeleteNon_existnode() {
		...
		TestCase1992.cssLocalManager.unregisterCSSNode(cssDetails);
		
		try {
			Name = TestCase1992.cssRegistry.getCssRecord().getName();
			LOG.info("[#1992] Name of this CSS is .................:" +Name);
		} catch (CssRegistrationException e) {
			LOG.info("[#1992] SpecificTestCaseUpperTester CssRegistrationException - Could not get the CSS Record Name from the CSS Registry");
			e.printStackTrace();
		}
		compareName = profile.getName();
		LOG.info("[#1992] CompareName of this CSS is .................:" +compareName);
		...
		LOG.info("[#1992] SpecificTestCaseUpperTester Delete Non_exist Node END.................");
