...
private static Logger LOG = LoggerFactory.getLogger(SpecificTestCaseUpperTester.class);
	...
	@Before
	public void setUp() {
		LOG.info("[#1994] SpecificTestCaseUpperTester::setUp");

		Future<CssInterfaceResult> interfaceResult = null;
		//CssRecord profile = null;
		
		profile = createCSSRecord();
		LOG.info("[#1994] SpecificTestCaseUpperTester CSS Record: profile:" +profile);

			// -- Create the CSS Record
		
			LOG.info("[#1994] SpecificTestCaseUpperTester Preamble: Create the CSS Record");
	}
	...
	public void tearDown() {
		LOG.info("[#1994] SpecificTestCaseUpperTester tearDown");
	}
	
	
	@Ignore
	public void bodyCreateNodetwice() {
		LOG.info("[#1994] SpecificTestCaseUpperTester create CSS Cloud Node");
		String Name = null;
		Name ="liam";
		String compareName;
		...
		try {
			...
			LOG.info("[#1994] SpecificTestCaseUpperTester CssRegistrationException - Could not get the CSS Record from the CSS Registry");
			e.printStackTrace();
		}
		...
		try {
			...
			LOG.info("[#1994] SpecificTestCaseUpperTester Name of CSS is .................:" +Name);
		} catch (CssRegistrationException e) {
			LOG.info("[#1994] SpecificTestCaseUpperTester CssRegistrationException - Could not get the CSS Record Name from the CSS Registry");
			e.printStackTrace();
		}
		...
		interfaceResult = TestCase1994.cssLocalManager.registerCSSNode(profile);
		LOG.info("[#1994] SpecificTestCaseUpperTester CreateNodetwice END.................");
	}
	...
	public void bodydeleteNon_existnode() {
		...
		TestCase1994.cssLocalManager.unregisterCSSNode(cssDetails);
		
		try {
			Name = TestCase1994.cssRegistry.getCssRecord().getName();
			LOG.info("[#1994] Name of this CSS is .................:" +Name);
		} catch (CssRegistrationException e) {
			LOG.info("[#1994] SpecificTestCaseUpperTester CssRegistrationException - Could not get the CSS Record Name from the CSS Registry");
			e.printStackTrace();
		}
		compareName = profile.getName();
		LOG.info("[#1994] CompareName of this CSS is .................:" +compareName);
		...
		LOG.info("[#1994] SpecificTestCaseUpperTester Delete Non_exist Node END.................");
