...
public class DatabaseConnectionImpl implements Variables, DatabaseConnection {
	private static final Logger logger = Logger.getLogger(DatabaseConnectionImpl.class);
