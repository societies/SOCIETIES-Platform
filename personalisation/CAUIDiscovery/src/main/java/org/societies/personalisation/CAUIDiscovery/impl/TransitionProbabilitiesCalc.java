...
public class TransitionProbabilitiesCalc {
	...
	public LinkedHashMap<String,HashMap<String,Double>> calcTrans2Prob(){
	 ...
	 */
	LinkedHashMap<List<String>,ActionDictObject> getStepDict(int steps){
		LinkedHashMap<List<String>,ActionDictObject> step2Dict = new  LinkedHashMap<List<String>,ActionDictObject>();
		for (List<String> act : dictionary.keySet()){
			if(act.size() == steps){
				step2Dict.put(act, dictionary.get(act));
			}
		}	
		return step2Dict;
	}
