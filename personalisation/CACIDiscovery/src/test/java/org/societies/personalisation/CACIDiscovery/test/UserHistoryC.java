...
public class UserHistoryC {
	...
	public Map<CtxHistoryAttribute, List<CtxHistoryAttribute>> createContextHistoryAttributesSet(){
		...
		IAction actionZ = new Action(serviceId1, "testService", "ZZZZ", "ZZZZ");
		...
		IAction actionO = new Action(serviceId1, "testService", "OOOO", "OOOO");
		...
		for (int i=0; i<4; i++){
			...
			monitorAction(actionO,"park","away",25);
			monitorAction(actionZ,"park","away",25);
