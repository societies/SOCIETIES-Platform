...
public class UserCtxAttributeMgr implements Serializable {
	...
	public UserCtxAttributeMgr() {
	}

	public UserCtxAttributeMgr(String operatorId, String type, long objectNumber, Date lastModified) {
